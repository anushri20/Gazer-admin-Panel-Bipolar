                     ...
                     <li>
                         <Link to="/#" className="waves-effect">
                                ...
                                <ul className="sub-menu" aria-expanded="false">
                                    ...
                                    <li><Link to="/Profile-List">{this.props.t('List Profiles') }</Link></li>
                                    <li><Link to="/#">{this.props.t('List of Videos') }</Link></li>
                                    <li><Link to="/#">{this.props.t('List of Files') }</Link></li>
                                    <li><Link to="/#">{this.props.t('List of Messages') }</Link></li>
                                    <li><Link to="/#">{this.props.t('List of Meetings') }</Link></li>
                                    <li><Link to="/#">{this.props.t('List of Rooms') }</Link></li>
                                </ul>
                     </li>
